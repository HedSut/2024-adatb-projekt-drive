    ...
    while (i < n):
        ...
        for x in column_data:
            if (x[1] == "i"):
                ...
                #INSERT INTO table VALUES (DATETIME 'YYYY-MM-DD HH:MI:SS');
                statement += f"DATETIME '{random.randint(2000, 2024)}-{random.randint(1, 12)}-{random.randint(1, 28)} {random.randint(0, 23)}:{random.randint(0, 59)}:{random.randint(0, 59)}', "
